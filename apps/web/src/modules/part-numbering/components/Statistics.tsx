...
export function Statistics({ totalParts, largestPart, smallestPart, averageSize, totalSheets, assemblyTime }: StatisticsProps) {
  const rows = [
    ["Total Parts", totalParts],
    ["Largest Part", largestPart],
    ["Smallest Part", smallestPart],
    ["Average Size", averageSize],
    ["Total Sheets", totalSheets],
    ["Estimated Assembly Time", assemblyTime],
  ];
