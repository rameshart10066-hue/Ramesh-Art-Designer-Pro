...
export function ProjectSummary({ designName, selectedSize, material, thickness, estimatedSheets, estimatedParts, assemblyDifficulty }: ProjectSummaryProps) {
  const rows = [
    ["Design Name", designName],
    ["Selected Size", selectedSize],
    ["Material", material],
    ["Thickness", thickness],
    ["Estimated Sheets", estimatedSheets],
    ["Estimated Parts", estimatedParts],
    ["Assembly Difficulty", assemblyDifficulty],
  ];
  ...
  return (
    ...
    >
      <h2 style={{ margin: 0, color: "#f8fafc", fontSize: 18, fontWeight: 700 }}>Project Summary</h2>
